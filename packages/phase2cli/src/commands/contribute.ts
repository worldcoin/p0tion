...
const contribute = async (opt: any) => {
    ...
    // Display World ID 4.0 ASCII art banner
    const orbAscii = `
          ::::-------------------------------------------::::::............
          :::::------------------====+*###%%##**+=---------:::::...........
          :::::----------------=#%%%%%%%%%%%%%%%%%%%%*=-----:::::..........
          ...
          .............................        ............................
`
    console.log(orbAscii)
    console.log(theme.colors.magenta(figlet.textSync("WORLD ID 4.0", { font: "ANSI Shadow" })))
    console.log(`\n${theme.text.bold("         Trusted Setup Ceremony - Securing the Future of Proof of Personhood")}\n`)
